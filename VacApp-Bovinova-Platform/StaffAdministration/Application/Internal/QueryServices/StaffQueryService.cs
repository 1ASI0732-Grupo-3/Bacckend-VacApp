...
{
    /// <summary>Retrieves all Staffs</summary>
    ...
    /// <summary>Retrieves a Staff entity by its unique identifier.</summary>
    /// <param name="query"></param>
    ...
    /// <summary>Retrieves all staffs by campaign ID.</summary>
    /// <param name="query"></param>
    ...
    /// <summary>Retrieves all staffs by status.</summary>
    /// <param name="query"></param>
    ...
    /// <summary>Retrieves a Staff entity by its name.</summary>
    /// <param name="query"></param>
    /// <returns></returns>
