...
namespace VacApp_Bovinova_Platform.VoiceCommand.Domain.Repositories;
...
public interface IVoiceRepository : IBaseRepository<Voice>
{
    ...
    public Task<IEnumerable<Voice>> FindByUserIdAsync(int userId);
    ...
    public Task<IEnumerable<Voice>> FindByUserIdWithPaginationAsync(int userId, int page, int size);
    ...
    public Task<IEnumerable<Voice>> FindByUserIdAndTypeAsync(int userId, VoiceCommandType commandType);
    ...
    public Task<IEnumerable<Voice>> FindRecentByUserIdAsync(int userId, int count);
    ...
    public Task<int> CountSuccessfulByUserIdAsync(int userId);
    ...
    public Task<int> CountByUserIdAndTypeAsync(int userId, VoiceCommandType commandType);
    ...
    public Task<VoiceCommandStats> GetStatsByUserIdAsync(int userId, DateTime? fromDate = null, DateTime? toDate = null);
}
