...
using VacApp_Bovinova_Platform.VoiceCommand.Domain.Model.Queries;
...
/// <summary>Service interface for querying voice commands</summary>
public interface IVoiceQueryService
{
    ...
    public Task<Voice?> Handle(GetVoicesByIdQuery query);
    ...
    public Task<IEnumerable<Voice>> Handle(GetVoicesByUserIdQuery query);
    ...
    public Task<IEnumerable<Voice>> Handle(GetVoicesByUserIdWithPaginationQuery query);
    ...
    public Task<IEnumerable<Voice>> Handle(GetVoicesByUserIdAndTypeQuery query);
    ...
    public Task<VoiceCommandStats> Handle(GetVoicesStatsByUserIdQuery query);
}
