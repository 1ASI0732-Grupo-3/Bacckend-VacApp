...
using VacApp_Bovinova_Platform.VoiceCommand.Domain.Model.Commands;
...
using VacApp_Bovinova_Platform.VoiceCommand.Interfaces.REST.transform;

namespace VacApp_Bovinova_Platform.VoiceCommand.Interfaces.REST
{
    [Authorize]
    [ApiController]
