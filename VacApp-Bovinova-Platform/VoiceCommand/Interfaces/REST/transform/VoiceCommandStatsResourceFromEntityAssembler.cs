...
/// <summary>Assembler to transform VoiceCommandStats to VoiceCommandStatsResource</summary>
public static class VoiceCommandStatsResourceFromEntityAssembler
{
    /// <summary>Transforms VoiceCommandStats to VoiceCommandStatsResource</summary>
